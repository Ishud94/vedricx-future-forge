...
const programs = [
  ...
  },
  {
    ...
    modules: [
      { week: "Week 1", title: "Engineering Drawing Mastery", topics: ["Orthographic & isometric projections", "First vs Third angle projection", "Section & detail views", "Dimensioning rules (ISO / ASME)", "Limits, fits & tolerances", "Reverse engineer drawing → 3D model"] },
      { week: "Week 2", title: "Parametric & Feature-Based Modeling", topics: ["Design intent & fully defined sketches", "Multi-body modeling & configurations", "Advanced features (Loft, Sweep, Shell, Draft)", "Surface modeling basics", "Projects: Mounting bracket, flange, shaft, housing"] },
      { week: "Week 3", title: "GD&T + Tolerance Engineering", topics: ["GD&T symbols & interpretation", "Datums & feature control frames", "Position, flatness, parallelism, perpendicularity", "Fit calculation & tolerance stack-up", "Apply GD&T on shaft-bearing system"] },
      { week: "Week 4", title: "Sheet Metal, Weldments & Fabrication", topics: ["Bend allowance & K-factor", "Flat pattern export", "Weld symbols & structural frames", "Cut list documentation", "Project: Industrial electrical enclosure"] },
      { week: "Week 5", title: "Assembly Design & BOM Strategy", topics: ["Bottom-up & Top-down modeling", "Mates, sub-assemblies & component library", "Interference detection & exploded view", "Bill of Materials generation", "Project: Two-stage Industrial Gearbox"] },
      { week: "Week 6", title: "Advanced Assembly & Motion", topics: ["Standard & advanced mates (Limit, Width)", "Sub-assembly structure management", "Interference & clearance verification", "BOM with balloons & assembly drawings", "Basic motion study & animation export"] },
      { week: "Week 7", title: "Capstone Industry Project", topics: ["Choose: Automotive Suspension / Hydraulic Press / Go-Kart Frame", "Complete CAD modeling & assembly", "GD&T + manufacturing drawings + BOM", "Basic static simulation & validation", "15-slide technical presentation"] },
    ],
