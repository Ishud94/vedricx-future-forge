...
const programs = [
  {
    ...
    reviewCount: 124,
    image: aircraftImg,
    brochure: "/brochures/aircraft-design-program.pdf",
  ...
  },
  {
    ...
    reviewCount: 98,
    image: cfdImg,
    brochure: "/brochures/cfd-program.pdf",
    ...
    modules: [
      { week: "Week 1", title: "Fundamentals of Fluid Flow & CFD", topics: ["Fluid properties & governing equations", "Newtonian & non-Newtonian fluids", "Laminar vs turbulent flows & Reynolds number", "Introduction to CFD workflow", "Projects: 2D & 3D Laminar Flow Analysis"] },
      { week: "Week 2", title: "Numerical Foundations using MATLAB", topics: ["Numerical discretization concepts", "Finite Difference Method (FDM)", "1D & 2D heat conduction solutions", "Comparison of numerical vs analytical solutions", "Project: 2D Heat Equation via FDM"] },
      { week: "Week 3", title: "Internal Flow Simulations (ANSYS Fluent)", topics: ["ANSYS Workbench & Fluent interface", "2D & 3D internal flow setup", "Solver settings & convergence monitoring", "Post-processing of velocity & pressure", "Projects: Pipe expansion & contraction flows"] },
      { week: "Week 4", title: "CFD Meshing Fundamentals", topics: ["Structured, unstructured & hybrid meshes", "ANSYS Meshing & ICEM CFD", "Mesh quality: Skewness, orthogonality, aspect ratio", "Boundary layer & inflation layers", "Y+ concept & mesh independence studies"] },
      { week: "Week 5", title: "Turbulence Modeling & RANS Simulations", topics: ["Reynolds decomposition & RANS equations", "k-ε, k-ω, k-ω SST models", "Vortex shedding & unsteady flow", "Turbulence model comparison", "Projects: Bluff body analysis & model comparison"] },
      { week: "Week 6", title: "Advanced CFD Applications", topics: ["Multiphase flow (VOF method)", "Heat transfer & conjugate heat transfer", "Unsteady simulations & UDFs", "External aerodynamic analysis", "Projects: VOF, forced convection, UDF, flow enhancement"] },
    ],
  ...
  },
  {
    ...
    reviewCount: 76,
    image: feaImg,
    brochure: "/brochures/fea-program.pdf",
  ...
  {
    title: "Mechanical Design Engineering Industry Training Program",
    subtitle: "SolidWorks Focus — Hands-On Industrial Mechanical Design",
    description: "Build strong hands-on skills in mechanical design using SolidWorks. The program focuses on practical modeling, drafting, and assembly creation required in real industry workflows. By the end of the course, learners will be able to design, modify, and document mechanical components and assemblies independently.",
    ...
    roles: ["Mechanical Design Engineer", "CAD Design Engineer", "SolidWorks Designer", "Product Design Intern", "Junior Design Engineer"],
    modules: [
      { week: "Day 1–2", title: "Introduction & Interface", topics: ["Introduction to SolidWorks environment", "Navigation, UI, and basic tools", "Understanding design workflow"] },
      { week: "Week 1", title: "2D Sketching", topics: ["Sketch tools (Line, Circle, Arc, Rectangle, etc.)", "Constraints & Relations", "Smart Dimensioning", "Sketch optimization techniques"] },
      { week: "Weeks 2–3", title: "3D Part Modeling", topics: ["Extrude, Revolve, Sweep, Loft", "Fillet, Chamfer, Shell, Patterns", "Reference Geometry (Planes, Axes)", "Editing & Modifying Parts", "Parametric Design Approach"] },
      { week: "Week 4", title: "Assembly Design", topics: ["Introduction to Assemblies", "Mates (Standard & Advanced)", "Sub-assemblies", "Interference Detection", "Motion basics"] },
      { week: "Week 5", title: "Drafting & 2D Drawings", topics: ["Creating Engineering Drawings", "Standard Views & Section Views", "Dimensioning & Tolerances (basic)", "Bill of Materials (BOM)"] },
      { week: "Week 6", title: "Sheet Metal Basics", topics: ["Sheet metal features (Base Flange, Edge Flange, etc.)", "Bends & Flattening", "Basic sheet metal components"] },
      { week: "Final Project", title: "Capstone Mechanical Assembly", topics: ["Create a complete mechanical assembly", "Generate part drawings + assembly drawing", "Apply real-world design approach"] },
    ],
    deliverables: ["Complete Mechanical Assembly (SolidWorks)", "Part & Assembly Drawings", "Bill of Materials (BOM)", "Final Capstone Project", "Certificate of Completion"],
    skills: ["2D Sketching & Engineering Drawings", "3D Part Modeling (Basic to Intermediate)", "Assembly Design & Mating Techniques", "Sheet Metal Design Basics", "Dimensioning & Drafting Standards", "Design Intent & Parametric Modeling", "Basic Design for Manufacturing (DFM)"],
  },
];
